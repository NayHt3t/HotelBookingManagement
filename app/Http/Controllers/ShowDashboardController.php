...
class ShowDashboardController extends Controller
{
    public function index(){
        ...
        $todayGuests = Stay::whereNull('check_out')->count();

        return view('admin.dashboard',compact('months','totalBooking','totalGuest','totalIncome','roomType','incomes','incomePer','guests','guestPer','bookings','bookingPer','clients','clientPer','todayBookings','todayGuests'));
    }
