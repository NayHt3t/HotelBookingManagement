          ...
          <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
            <div class="card card-plain mt-8">
              <div class="card-header pb-0 text-left bg-transparent">
                ...
                <p class="mb-0">Please fill in your login details<br></p>
              </div>
              <div class="card-body">
              ...
              <div class="card-footer text-center pt-0 px-lg-2 px-1">
                <small class="text-muted">Forgot you password? 
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">Contact Admin</a>
                </small>
